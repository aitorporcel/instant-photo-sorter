...
def train_model(model, criterion, optimizer, train_loader, val_loader, device, writer, num_epochs=25):
...
def evaluate_model_per_class(model, val_loader, criterion, device):
